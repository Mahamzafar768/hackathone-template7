...
export default function page() {
  return (
    <div className="w-full flex flex-col lg:flex-row">
      ...
      {/* Main Content */}
      <div className="sec w-full lg:w-[75%] bg-[#f6f7f9] p-4 sm:p-6 flex flex-col gap-10 font-[family-name:var(--font-geist-sans)]">
        
        {/* Section 1: Image & Rent Now Card */}
        <section className="w-full flex flex-col md:flex-row gap-5 items-center justify-between">
          ...
          <div className="flex flex-col w-full lg:max-w-[492px] h-auto lg:max-h-[508px] bg-white justify-between rounded-xl shadow-md">
            <Image src={"/Detail Car (1).png"} alt="Detail Car" width={492} height={392} className="w-full h-auto rounded-t-xl object-cover"/>
            <div className="p-4 flex items-center gap-4">
              <div className="flex items-center justify-between w-full">
                <h1 className="font-bold text-lg sm:text-xl lg:text-2xl">$80.00 / <span className="text-gray-500 text-sm lg:text-base">day $100.00</span></h1>
              </div>
              <Link href={"/payment"}>
        ...
        <section className="popular w-full flex flex-col gap-5">
          ...
          <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xl:px-5">
            {/* Repeat Cards for Recommended Cars */}
            {/* Example of Recommended Car Card 1 */}
            <Card className="w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between">
              <CardHeader>
                <CardTitle className="w-full flex items-center justify-between">
            ...
            {/* Add similar cards for other recommended cars */}
          </div>
        </section>
      </div>
    </div>
